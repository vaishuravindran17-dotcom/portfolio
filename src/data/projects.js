export const projects = [
  ...
  },
  {
    ...
    role: 'Product Designer',
    year: '2024–Present',
    tags: ['Climate Tech', 'AI', 'ESG', 'B2B', 'Enterprise'],
    sections: [
      {
        label: 'Goal',
        feeling: "Creating an ESG report is one of the hardest things a sustainability team does. Hundreds of data points. Multiple frameworks. Documents scattered across systems. Questionnaires from investors and customers arriving constantly. We built a library of AI agents to ease every part of that process.",
        thinking: "Greenskills is Carboledger's AI ESG agent platform. It provides a library of purpose-built agents that help sustainability managers collect data, respond to questionnaires, benchmark against peers, and navigate reporting frameworks — reducing the manual effort involved in ESG reporting across 700 to 800 data points.",
      },
      {
        label: 'Role',
        feeling: "I researched which agents to build, spoke to users to understand where the pain actually was, figured out what the AI should say and how, and designed the experience around each agent. Every agent had its own logic, its own user, its own stakes.",
        thinking: "Lead designer. Responsible for agent use case research, user pain point definition, AI response option design, conversation interface design, and knowledge base architecture. Working across agents in various stages from live to in progress.",
      },
      {
        label: 'Knowledge Base',
        media: { type: 'image', src: '/Knowledge_base.png' },
        feeling: "Before any agent can help, it needs to know who you are. The knowledge base is where a company uploads its ESG reports, policies, CDP and EcoVadis disclosures. Every agent draws from this when it responds. The quality of the answers depends on the quality of what's in here.",
        thinking: "The knowledge base is the foundation layer for all agents on the platform. Users upload ESG reports, strategy documents, climate risk management policies, and external disclosures. Agents reference this knowledge base to generate contextually accurate, company-specific responses rather than generic outputs.",
      },
      {
        label: 'Agents Library',
        media: { type: 'image', src: '/Skill_agents.png' },
        feeling: "Six agents. Each one designed to take something painful off a sustainability manager's plate. Respond to questionnaires. Collect scope data. Benchmark against peers. Assess materiality. Train employees. Navigate CSRD. Each agent is its own product inside the product.",
        thinking: "The Agents Library surfaces six purpose-built ESG agents, each targeting a distinct reporting pain point. Agents are filterable by type and status. Users can pin frequently used agents, view activity, and request new agents. Two agents currently active in production: Respond to questionnaire and Scope 1 & 2 data collection.",
      },
      {
        label: 'Respond to Questionnaire',
        media: { type: 'video', src: '/Respond_to_questionnaire.mp4' },
        feeling: "Sustainability questionnaires from investors and customers arrive constantly. Each one is different. Each one takes hours to fill. This agent reads the questionnaire, reads the company's knowledge base, and generates responses. The sustainability manager reviews instead of writes.",
        thinking: "The questionnaire response agent accepts uploaded questionnaire files in .xls and .xlsx format, up to 70 questions per session. It generates responses based on the company's knowledge base and ESG policies, with configurable AI response tone and format. Session history is maintained for tracking and export. Designed to shift the user's role from author to reviewer.",
      },
      {
        label: 'Scope 1 & 2 Data Collection',
        media: [
          { type: 'video', src: '/Scope_1___2_data_collection_-_Collector_view.mp4' },
          { type: 'video', src: '/Scope_1___2_data_collection_-_Data_providers_view.mp4' },
        ],
      ...
      },
      {
        ...
        media: { type: 'video', src: '/Peer_benchmarking.mp4' },
      ...
      {
        label: 'CSRD Agent',
        media: { type: 'video', src: '/CSRD_agent.mp4' },
      ...
      {
        label: 'The Design Challenge',
        feeling: "Every agent was different. The problem was not designing one AI interface but designing six — each with its own logic, its own user, its own way of failing. Making sure responses felt adequate across different company contexts, comparing outputs across time to check for consistency, figuring out what metrics actually meant something. The hardest part was that there was no playbook.",
        thinking: "Designing AI agents for ESG reporting required solving a different problem per agent — what data to surface, what response options to provide, how to structure conversations that varied significantly by company context and knowledge base quality. Ensuring response adequacy, building comparison frameworks across agent sessions, and defining authenticity metrics were the core design and research challenges across the suite.",
      },
    ],
  },
  {
